...
def main():
    ...
    state_dict0=torch.load("/data/Pweight/gpt2xl_weight1.pt") # /data/Pweight/0_gpt2xl.pth  gpt2xlHugginFace_pweight.pth
    ...
    for step,(data,label) in enumerate(gptdataloader):
        ...
        if (step+1)%accumulation_steps ==0:
            ...
            if(real_step%389==0 and ddp_rank==0):
                ...
                torch.save(state,"/data/Pweight/P%d_gpt2xl_1112.pth"%real_step)
                pass
            real_step+=1
